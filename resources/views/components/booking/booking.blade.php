                                                ...
                                                <div class="form-check custom-option custom-option-icon">
                                                    <label class="form-check-label custom-option-content"
                                                          ...
                                                          <span class="custom-option-body">
                                                            ...
                                                            <span class="custom-option-title"> Eastern Standard Time (EST) </span>
                                                            <h5>
                                                                Select this option if you are located in the Eastern Standard Time (EST) zone
                                                            </h5>
                                                          </span>
                                                        <input
                                            ...
                                            <div class="col-md-6 mb-md-0 mb-5">
                                                <div class="form-check custom-option custom-option-icon">
                                                    <label class="form-check-label custom-option-content"
                                                          ...
                                                          <span class="custom-option-body">
                                                            <i class="fa-solid fa-globe" style="color: black;"></i>
                                                            <span class="custom-option-title"> Central Standard Time (CST) </span>
                                                            <h5>
                                                                Select this option if you are located in the Central Standard Time (CST) zone
                                                            </h5>
                                                          </span>
                                                        <input
                                                            class="form-check-input"
                                            ...
                                            <div class="col-md-6 mb-md-0 mb-5">
                                                <div class="form-check custom-option custom-option-icon">
                                                    <label class="form-check-label custom-option-content"
                                                          ...
                                                          <span class="custom-option-body">
                                                            <i class="fa-solid fa-globe" style="color: black;"></i>
                                                            <span class="custom-option-title"> Mountain Standard Time (MST) </span>
                                                            <h5>
                                                                Select this option if you are located in the Mountain Standard Time (MST) zone
                                                            </h5>
                                                          </span>
                                                        <input
                                                            class="form-check-input"
                                            ...
                                            <div class="col-md-6 mb-md-0 mb-5">
                                                <div class="form-check custom-option custom-option-icon">
                                                    <label class="form-check-label custom-option-content"
                                                          ...
                                                          <span class="custom-option-body">
                                                            <i class="fa-solid fa-globe" style="color: black;"></i>
                                                            <span class="custom-option-title"> Pacific Standard Time (PST) </span>
                                                            <h5>
                                                                Select this option if you are located in the Pacific Standard Time (PST) zone
                                                            </h5>
                                                          </span>
                                                        <input
                                                            class="form-check-input"
                                ...
                                <div id="property-area" class="content">
                                    <div class="row g-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea required id="plAddress" name="plAddress" class="form-control"
                                                      rows="3"
                                            ...
                                            <div class="form-check my-2 ms-2">
                                                ...
                                                <label class="form-check-label" for="plOtherCharges">
                                                    By proceeding, you confirm that you have read and agree to <a
                                                        ...
                                                        href="https://weincentivize.com/privacy-policy" target="_blank">
                                                        Privacy Notice.</a>
                                                </label>
                                            </div>
                                        </div>
