...
<head>
    ...
    <style>
        ...
        .light-style .bs-stepper .bs-stepper-header .bs-stepper-title, .light-style .bs-stepper .bs-stepper-header .bs-stepper-label {
            color: black;
            font-size: 21px;
        }
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
                        <div class="bs-stepper-header border-end">
                            ...
                            <h4 class="text-center m-0 pt-5 text-uppercase" style="font-weight: bold;">Visit Us Online At:</h4>
                            <a class="text-center" href="https://weincentivize.com/"><h5>www.weincentivize.com</h5></a>
                            ...
                            <form id="wizard-property-listing-form" onSubmit="return false">
                                    ...
                                    <div class="row g-6">
                                        ...
                                        <div class="col-md-12 p-6">
                                            ...
                                            <div class="d-flex gap-4 flex-wrap mt-4">
                                                <button type="button" class="btn custom-btn-outline waves-effect">
                                                    12:00am
                                                </button>
                                                <button type="button" class="btn custom-btn-outline waves-effect">
                                                    12:30am
                                                    ...
                                                    <div class="form-check custom-option custom-option-icon">
                                                        <label class="form-check-label custom-option-content" for="customRadioSell">
                                                              <span class="custom-option-body">
                                                                ...
                                                                <span class="custom-option-title">New Customer</span>
                                                              </span>
                                                            <input
                                                                name="plPropertySaleRent"
                                                    ...
                                                    <div class="form-check custom-option custom-option-icon">
                                                        <label class="form-check-label custom-option-content" for="customRadioRent">
                                                                  <span class="custom-option-body">
                                                                    ...
                                                                    <span class="custom-option-title">Existing Customer</span>
                                                                  </span>
                                                            <input
                                                                name="plPropertySaleRent"
                                                                class="form-check-input"
                                ...
                                <div id="property-area" class="content">
                                    <div class="row g-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="plweb">Current Website or Social Media Page</label>
                                            <input
                                                type="text"
                                                id="plweb"
                                                name="plweb"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="plbrand">Name Of Business or Brand</label>
                                            <input
                                                type="text"
                                                id="plbrand"
                                                name="plbrand"
